package cn.sf_soft.finance.funds.service;
...
public interface FundsAccountService {
	 ...
	 * @return
	 */
	public int  getFundsAccountsCount(final FundsAccountsSearchCriteria serchCriteria);
	/**
	 * 获取出入明细总记录数
	 * @param serchCriteria
	 * @return
	 */
	public int getFinanceDocumentEntriesCount(final FundsAccountsSearchCriteria serchCriteria);
	/**
	 * 获取 出入明细总计
	 * @param serchCriteria
	 * @return
	 */
	public TotalCountOfFinance getTotalCountOfFinance(final FundsAccountsSearchCriteria serchCriteria);
	 ...
	 * @return
	 */
	public TotalCountOfFundsAccounts getTotalCountOfFundsAccounts(final FundsAccountsSearchCriteria serchCriteria);
	/**
	 * 初始化查询条件
	 * @return
	 */

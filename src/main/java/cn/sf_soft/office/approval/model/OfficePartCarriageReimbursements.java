...
/**
 * 配件运费报销主表 OfficePartCarriageReimbursements entity. @author MyEclipse
 * Persistence Tools
 */

public class OfficePartCarriageReimbursements extends
		ApproveDocuments<OfficePartCarriageReimbursementsDetails> implements
	...
	/** default constructor */
	public OfficePartCarriageReimbursements() {
	}

	/** minimal constructor */
	public OfficePartCarriageReimbursements(String documentNo,
			String stationId, Short status, Double reimburseAmount,
			Timestamp reimburseTime, String userId, String userNo,
	...
	//
	// public void
	// setApportionments(Set<OfficeAssetsReimbursementsApportionments>
	// apportionments) {

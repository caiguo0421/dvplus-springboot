 ...
 *
 */
public class VehicleSaleContractDetailVary implements java.io.Serializable {
	...
	private Timestamp bestDeliverTime;  //新增最佳交付 caigx 20170310
	private Timestamp oriBestDeliverTime;
	...
	private Double oriDeposit;

	// Constructors
	public VehicleSaleContractDetailVary() {
	}
	...
	public Timestamp getOriBestDeliverTime() {
		return oriBestDeliverTime;
	}



	public void setOriBestDeliverTime(Timestamp oriBestDeliverTime) {
		this.oriBestDeliverTime = oriBestDeliverTime;
	}
	...
	public Double getOriDeposit() {
		return oriDeposit;
	}



	public void setOriDeposit(Double oriDeposit) {
		this.oriDeposit = oriDeposit;
	}

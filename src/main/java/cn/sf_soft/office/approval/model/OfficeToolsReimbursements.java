...
public class OfficeToolsReimbursements extends
		ApproveDocuments<OfficeToolsReimbursementsDetails> implements
	...
	private Set<OfficeToolsReimbursementsApportionments> apportionments;
	...
	/** default constructor */
	public OfficeToolsReimbursements() {
	}

	/** minimal constructor */
	public OfficeToolsReimbursements(String documentNo, String stationId,
	...
	public Set<OfficeToolsReimbursementsApportionments> getApportionments() {
		return apportionments;
	}

	public void setApportionments(
			Set<OfficeToolsReimbursementsApportionments> apportionments) {

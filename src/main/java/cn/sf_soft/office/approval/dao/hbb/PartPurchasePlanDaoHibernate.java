...
@Repository("partPurchasePlanDao")
public class PartPurchasePlanDaoHibernate extends BaseDaoHibernateImpl implements PartPurchasePlanDao{

	static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(PartPurchasePlanDaoHibernate.class);

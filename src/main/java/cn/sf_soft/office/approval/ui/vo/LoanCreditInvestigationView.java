...
public class LoanCreditInvestigationView extends VwOfficeApproveDocuments{
	...
	public LoanCreditInvestigationView(){
		
	}

	
	public static LoanCreditInvestigationView fillDataByVwDocuments(VwOfficeApproveDocuments vwOfficeApproveDocuments){
		LoanCreditInvestigationView varyApproval=new LoanCreditInvestigationView();

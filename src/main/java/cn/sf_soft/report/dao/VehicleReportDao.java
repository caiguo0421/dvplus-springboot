...
public interface VehicleReportDao extends BaseDao {
	 ...
	 * @throws Exception
	 */
	public List<VehicleMonthlyReport> getMonthlySaleReportData(String dateTime, String analyseType, List<String> stationIds,String datetype, String stateContent);
